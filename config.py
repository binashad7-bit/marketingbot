...
class Config:
    ...
    ENABLE_AI_PERSONALIZATION = os.getenv(
        ...
        'true' if (GEMINI_API_KEYS or OPENAI_API_KEY) else 'false'
    ).lower() == 'true'
    ...
    FACEBOOK_TEXT_PROVIDER = os.getenv('FACEBOOK_TEXT_PROVIDER', 'openai').lower()
    ...
    FACEBOOK_TEST_POST_ON_DEPLOY = os.getenv('FACEBOOK_TEST_POST_ON_DEPLOY', 'false').lower() == 'true'
