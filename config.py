...
class Config:
    ...
    EMAIL_ENRICH_INTERVAL_MINUTES = int(os.getenv('EMAIL_ENRICH_INTERVAL_MINUTES', 60))
    ...
    EMAIL_ENRICH_LIMIT = int(os.getenv('EMAIL_ENRICH_LIMIT', 150))
    HUNTER_SEARCHES_PER_RUN = int(os.getenv('HUNTER_SEARCHES_PER_RUN', 10))
    WEBSITE_EMAIL_MAX_PAGES = int(os.getenv('WEBSITE_EMAIL_MAX_PAGES', 16))
